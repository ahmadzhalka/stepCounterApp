...
public class ReminderReceiver extends BroadcastReceiver {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "com.ahmadmatan.CrashAlert";
    ...
    private boolean checkToActivateReminder(Context context) {
        ...
        boolean isServiceRunning = StepCounterService.isMyServiceRunning(context);
    ...
    private void actionToService(Context context, String action) {
        Intent startIntent = new Intent(context, StepCounterService.class);
